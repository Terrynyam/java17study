...
public class SetNavigation {
    public static void main(String... args){
        ...
        //The elements are maintained according to the natural ordering for Strings— that is, the one defined by the
        //compareTo() method of the Comparable<String> interface implemented by the String class.
        ...
        out.println(strSetA.subSet("A", false, "Z", false ));
        // [Java, Strictly]
        out.println(strSetA.subSet("a", false, "z", false ));
        // [ballroom, dancing]
