...
public class SupplierClient {
    public static void main(String[] args) {
        ...
        System.out.println(intRefList);//[22, 70, 14, 32, 33]
        ...
        System.out.println(stringbuilderList);//[str2, str0, str7, str8, str8, str5]

        // Build a list that has the same string: (7)
        List<String> stringList2 = listBuilder(4, () -> "Mini me");
        System.out.println(stringList2);//[Mini me, Mini me, Mini me, Mini me]

        // Build a list of LocalTime: (8)
        List<LocalTime> dateList1 = listBuilder(3, () -> LocalTime.now());
        System.out.println(dateList1);//[16:38:48.170202700, 16:38:48.170202700, 16:38:48.170202700]
